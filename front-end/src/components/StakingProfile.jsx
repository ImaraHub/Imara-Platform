...
import { ArrowLeft, Upload, Github, Linkedin } from 'lucide-react';
...
function StakingProfile({ onBack }) {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto mb-12">
          ...
          <p className="text-xl text-gray-400">
            Showcase your skills, experience, and professional details to get approved for this project.
          </p>
        </div>
